...
public class KueAdapter extends RecyclerView.Adapter<KueAdapter.KueViewHolder> {
    ...
    Context context;
    public KueAdapter(Context ct, String s1[], String s2[], String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    public KueViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_kue, parent, false);
    ...
    public class KueViewHolder extends RecyclerView.ViewHolder {
        ...
        public KueViewHolder(View itemView) {
            super(itemView);
