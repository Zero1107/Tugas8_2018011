...
import static com.example.hiraethkitchen.DBmain.TABLENAME;
...
import com.example.hiraethkitchen.databinding.ActivityMain3Binding;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("tabelkue", null, cv);
                if (rec != null) {
